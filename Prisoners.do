use NationalPrisonersStatistics.dta 
...
frget population_total black_population, from (population_frame)


gen nonblack_population = population_total - black_population 
